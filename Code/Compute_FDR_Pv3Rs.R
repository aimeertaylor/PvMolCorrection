...
# RecurrentVivax/../LargeFiles/ (see below) are git ignored. They can be
# generated by running Pooled_Analysis.Rmd. I am using copies of the original
# files
...
#===============================================================================
# Run Pv3Rs: if exact joint inference is not possible, returns NAs
#===============================================================================
if (Run_probs){
  tic()
